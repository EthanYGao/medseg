...
def uvnet_2d_bn_roi(dim_data, dim_label, num_class, phase='train'):
	...
	############ get roi ############
	net.roi_mask, net.roi_coordinate = L.ROICoordinate(net.upscore3, pad=16, ntop=2, propagate_down=0)
	...
	### a ### Third Deconvolution
	############ roi warping ############
	net.u1a_roi_warping = L.ROIWarping(net.u2f_relu, net.roi_coordinate, pooled_h=208, pooled_w=208, spatial_scale=0.125, propagate_down=[1,0])
	if phase == "train":
		net.roi_label = L.ROIWarping(net.label, net.roi_coordinate, pooled_h=416, pooled_w=416, spatial_scale=1, propagate_down=[0,0])
	# net.u1a_dconv, net.u1a_bn, net.u1a_scale, net.u1a_relu = deconv_bn_relu(net.u2f_relu, 128, pad=0, kernel_size=2, stride=2)
	# net.u1b_concat = L.Concat(net.u1a_relu, net.d1e_eltw, axis=1)
	...
	net.u0a_dconv, net.u0a_bn, net.u0a_scale, net.u0a_relu = deconv_bn_relu(net.u1f_relu, 64, pad=0, kernel_size=2, stride=2)
	############ roi warping ############
	net.u0a_roi_warping = L.ROIWarping(net.d0c_conv, net.roi_coordinate, pooled_h=416, pooled_w=416, spatial_scale=1, propagate_down=[1,0])
